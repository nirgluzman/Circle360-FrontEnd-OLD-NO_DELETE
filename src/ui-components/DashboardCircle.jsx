    ...
    >
      ...
      >
        ...
        <View
          ...
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "CircleDeleteIcon")}
        >
          <Icon
            width="17.5px"
            height="22.5px"
            ...
            left="20.83%"
            right="20.83%"
            {...getOverrideProps(overrides, "Vector36943887")}
          ></Icon>
        </View>
        <View
          width="25px"
          ...
          left="275px"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "CircleConfigIcon")}
        >
          <Icon
            width="25px"
            height="25px"
            ...
            left="0%"
            right="0%"
            {...getOverrideProps(overrides, "Vector37552729")}
          ></Icon>
        </View>
        <Text
          fontFamily="Inter"
